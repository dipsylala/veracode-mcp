...
// checks if the EntityModelManualFinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityModelManualFinding{}

// EntityModelManualFinding struct for EntityModelManualFinding
type EntityModelManualFinding struct {
...
func (o EntityModelManualFinding) ToMap() (map[string]interface{}, error) {
...
type NullableEntityModelManualFinding struct {
	value *EntityModelManualFinding
	isSet bool
}

func (v NullableEntityModelManualFinding) Get() *EntityModelManualFinding {
	return v.value
}

func (v *NullableEntityModelManualFinding) Set(val *EntityModelManualFinding) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityModelManualFinding) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityModelManualFinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityModelManualFinding(val *EntityModelManualFinding) *NullableEntityModelManualFinding {
	return &NullableEntityModelManualFinding{value: val, isSet: true}
}

func (v NullableEntityModelManualFinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityModelManualFinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
