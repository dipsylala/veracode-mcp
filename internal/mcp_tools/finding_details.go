...
func lookupApplicationGUID(ctx context.Context, client *rest.VeracodeClient, appProfile string) (string, error) {
...
func tryGetStaticFlaw(ctx context.Context, client *rest.VeracodeClient, appGUID string, flawID int) (interface{}, error) {
	authCtx := client.GetAuthContext(ctx)
...
func tryGetDynamicFlaw(ctx context.Context, client *rest.VeracodeClient, appGUID string, flawID int) (interface{}, error) {
	authCtx := client.GetAuthContext(ctx)
	issueIDStr := strconv.Itoa(flawID)
